...
# 	dim_check ✓⧄
# ------------------------------------------------------------------------------
using Tullio # for batched matrix multiplication and transposition
...
# batched matrix multiplication
function batched_matrix_multiplication(A::Array{Float32}, B::Array{Float32})
	...
	C = @tullio C[b, i, j] := A[b, i, k] * B[b, k, j]
